...
public class SecurityConfig {
    ...
    private final String[] customerApi = {"/api/booking/booking-in-month", "/api/booking/book", "/api/payment/get-vnpay-url", "/api/booking/update-booking", "/api/booking/cancel/**", "/api/review"};
